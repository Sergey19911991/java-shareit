...
public class BookingServiceTest {
    ...
    public void getAll() {
        ...
        when(userRepositoryJpa.existsById(1)).thenReturn(true);
        when(bookingsRepository.getAllBooking(1)).thenReturn(list);

        Assertions.assertEquals(list, bookingService.getAllBooking("ALL", 1, UserType.Type.BOOKER, null, null));
    }
    ...
    public void getAll1() {
        ...
        when(userRepositoryJpa.existsById(1)).thenReturn(true);
        when(bookingsRepository.getAllOwnerBooking(1)).thenReturn(list);

        Assertions.assertEquals(list, bookingService.getAllBooking("ALL", 1, UserType.Type.OWNER, null, null));
    }
