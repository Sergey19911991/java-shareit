...
public class BookingController {
    ...
    @GetMapping
    public List<Booking> getBookingUser(@RequestParam(value = "state", defaultValue = "ALL") String state, @RequestHeader("X-Sharer-User-Id") int booker, @RequestParam(value = "from", defaultValue = "0") Integer from, @RequestParam(value = "size", defaultValue = "10") Integer size) {
        return bookingServiceimpl.getAllBooking(state, booker, UserType.Type.BOOKER, from, size);
    }

    @GetMapping(value = "/owner")
    public List<Booking> getAllBookingOwner(@RequestParam(value = "state", defaultValue = "ALL") String state, @RequestHeader("X-Sharer-User-Id") int owner, @RequestParam(value = "from", defaultValue = "0") Integer from, @RequestParam(value = "size", defaultValue = "10") Integer size) {
